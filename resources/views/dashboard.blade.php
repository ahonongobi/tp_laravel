                            ...
                            <div class="table-wrapper">
                                <div class="table-title">
                                    <div class="row d-flex">
                                        <div class="col-sm-8"><h2>Voiure <b>management</b></h2></div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$item->code_voiture}}</td>
                                            <td>{{$item->voiture_nom}}</td>
                                            <td>{{substr($item->voiture_description,0,30)}}...</td>
                                ...
                                <a  href="{{'/dashboardcommades'}}" type="button"  class="btn btn-info add-new"><i class="fa fa-question"></i> Listes de demandes de locations</a>

                            </div>
                        </div>
                        <div class="row pagination d-flex justify-content-center">{!! $allCar->appends(Request::all())->links() !!}</div>
